...
submit.onclick = async function getWeather() {
  ...
  const response = await fetch(
    `https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=8fb5d72f02341b18384fc6fc21f551da`,
    { mode: 'cors' }
  );

  if (response.status === 404) {
    alert(
      'Oops! We could not find this city, please try again with a different city'
    );
  }
    ...
    switch (weatherStatus) {
      case 'Clear':
        ...
        document.body.style.background =
          'url("https://ak.picdn.net/shutterstock/videos/32781985/thumb/1.jpg")';
      ...
      case 'Snow':
        ...
        document.body.style.background =
          'url("https://wallpaperaccess.com/full/697291.jpg")';
        document.body.style.backgroundSize = 'cover';
        document.body.style.backgroundPosition = 'center';
        document.body.style.backgroundRepeat = 'no-repeat';
        break;
      case 'Rain':
        ...
        document.body.style.background =
          'url("https://www.rainstreammedia.com/wp-content/uploads/2017/09/Animated-Rain-Gif-Background-Photography-rain-wallpaper.jpg")';
        document.body.style.backgroundSize = 'cover';
        document.body.style.backgroundPosition = 'center';
        document.body.style.backgroundRepeat = 'no-repeat';
        break;
      ...
      case 'Haze':
        img.src = './icons/cloud.png';
        document.body.style.background =
          'url("https://d1acid63ghtydj.cloudfront.net/09-10-2018/t_bc3e74a6f3cd4aa7827169e691066448_name_fog.JPG")';
        document.body.style.backgroundSize = 'cover';
        document.body.style.backgroundPosition = 'center';
        document.body.style.backgroundRepeat = 'no-repeat';
        break;
      case 'Mist':
        img.src = './icons/cloud.png';
        document.body.style.background =
          'url("https://c0.anyrgb.com/images/135/698/nature-weather-outdoors-fog-mist-grey-mountain-wallpaper-background-yosemite.jpg")';
        document.body.style.backgroundSize = 'cover';
        document.body.style.backgroundPosition = 'center';
        document.body.style.backgroundRepeat = 'no-repeat';
        break;
